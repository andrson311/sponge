...
// void MeshSkinned::CountVerticesAndIndices(const aiScene *pScene, unsigned int &NumVertices, unsigned int &NumIndices)
// {
...
// void MeshSkinned::ReserveSpace(unsigned int NumVertices, unsigned int NumIndices)
// {
...
// void MeshSkinned::InitSingleMesh(unsigned int MeshIndex, const aiMesh *paiMesh)
// {
...
// void MeshSkinned::LoadMeshBones(unsigned int MeshIndex, const aiMesh *pMesh)
// {
...
// void MeshSkinned::LoadSingleBone(unsigned int MeshIndex, const aiBone *pBone)
// {
...
// unsigned int MeshSkinned::FindPosition(float AnimationTimeTicks, const aiNodeAnim *pNodeAnim)
// {
...
// unsigned int MeshSkinned::FindRotation(float AnimationTimeTicks, const aiNodeAnim *pNodeAnim)
// {
...
// unsigned int MeshSkinned::FindScaling(float AnimationTimeTicks, const aiNodeAnim *pNodeAnim)
// {
